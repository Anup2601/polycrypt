    ...
    dden  ">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col gap-12 xl:ml-72 m-2 items-center ">
          {/* Testimonial 1 */}
          <div className="border border-white p-4 max-w-2xl ml-auto relative ">
            ...
            <p className="mt-2 text-lg font-semibold text-[#0CCAED]">
              - Garima Bhadri, HR Head, BlockSynergy Technology
            </p>
          </div>

          {/* Testimonial 2 */}
          <div className="border border-white p-4  max-w-2xl mr-auto relative ">
            <div className="absolute left-0 top-0 h-full w-[10px] bg-[#0CCAED]" />
            <p className="text-lg md:text-xl leading-relaxed font-semibold">
